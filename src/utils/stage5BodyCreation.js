...
const createBodies = (width, height) => {
  ...
  const platform1 = Matter.Bodies.rectangle(width / 1.2,height * 0.8, width / 30, 200, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
  ...
  const platform2 = Matter.Bodies.rectangle(width / 1.4, height * 0.9, width / 7, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform3 = Matter.Bodies.rectangle(width / 2.1, height * 0.8, width / 5, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform4 = Matter.Bodies.rectangle(width / 3, height * 0.65, width / 9, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform5 = Matter.Bodies.rectangle(width / 1.22, height * 0.63, width / 12, 20, {
    isStatic: true,
    angle:10,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
  ...
  const platform6 = Matter.Bodies.rectangle(width / 1, height * 0.8, width / 3.5, 20, {
    isStatic: true,
    angle:90,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
  ...
  const platform8 = Matter.Bodies.rectangle(width / 1.5, height * 0.6, width / 4.2, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const goal = Matter.Bodies.rectangle(width / 1.11, height * 0.91, 80, 50, {
    isStatic: true,
    isSensor: true,
    render: {
      sprite: {
  ...
  const movingPlatform = Matter.Bodies.rectangle(width / 2, 1000, 10, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
  ...
  const windmill = createWindmill(3 * width / 4, 1000, 20, 100);

  return { player, ground, platform1, platform2, platform3, platform4, platform5, platform6, platform8, goal,
