...
const createBodies = (width, height) => {
  ...
  const platform1 = Matter.Bodies.rectangle(200, 500, width / 15, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
  ...
  const platform2 = Matter.Bodies.rectangle(300, 450, width / 15, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform3 = Matter.Bodies.rectangle(400, 400, width / 15, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform4 = Matter.Bodies.rectangle(500, 350, width / 15, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform5 = Matter.Bodies.rectangle(600, 300, width / 15, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const platform6 = Matter.Bodies.rectangle(800, 250, width / 4, 20, {
    isStatic: true,
    friction: PLATFORM_FRICTION,
    restitution: PLATFORM_RESTITUTION,
    render: { fillStyle: 'white' }
  ...
  const goal = Matter.Bodies.rectangle(750, 200, 80, 50, {
    isStatic: true,
    isSensor: true,
    render: {
      sprite: {
  ...
  return { player, ground, platform1, platform2, platform3, platform4, platform5, goal,
    movingPlatform ,windmill, platform6};
};
